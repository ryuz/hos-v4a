...
/** コンストラクタ */
void Pc16550Drv_Create(C_PC16550DRV *self, void *pRegAddr, int iRegStep, int iIntNum, long lSysClock, int iBufSize)
{
	void *pMem;
	...
	/* Pc16550Hal 初期化 */
	Pc16550Hal_Create(&self->Pc16550Hal, pRegAddr, iRegStep, lSysClock);
