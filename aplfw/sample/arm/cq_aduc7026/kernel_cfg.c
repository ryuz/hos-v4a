...
#include "arch/irc/arm/aduc7000/ircatr.h"
#include "arch/irc/arm/aduc7000/irc.h"
...
VP_INT _kernel_hep_memblk[((256) + sizeof(VP_INT) - 1) / sizeof(VP_INT)];
...
const INTNO _kernel_max_intno = 23;

_KERNEL_T_INTINF _kernel_int_tbl[23];
