...
(
	[
		...
		[
			...
			"file_write.c",
			"stdfile.c",
			"syncdrv_clearreadsignal.c",
			"syncdrv_clearwritesignal.c",
			"syncdrv_constructor.c",
			"syncdrv_create.c",
			"syncdrv_delete.c",
			"syncdrv_destructor.c",
			"syncdrv_iocontrol.c",
			"syncdrv_refreadsignal.c",
			"syncdrv_refwritesignal.c",
			"syncdrv_setreadsignal.c",
			"syncdrv_setwritesignal.c",
			"syncdrv_waitreadsignal.c",
			"syncdrv_waitwritesignal.c",
