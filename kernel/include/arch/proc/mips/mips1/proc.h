 ...
 *
 * @file  proc.h
 * @brief %jp{MIPS1 プロセッサ制御}%en{processor control}
 *
...
#ifndef _KERNEL__arch__proc__mips__mips1__proc_h__
#define _KERNEL__arch__proc__mips__mips1__proc_h__
...
#endif	/* _KERNEL__arch__proc__mips__mips1__proc_h__ */
