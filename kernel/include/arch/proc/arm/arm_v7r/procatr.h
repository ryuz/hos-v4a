...
#ifndef _KERNEL__arch__proc__arm__arm_v7r__procatr_h__
#define _KERNEL__arch__proc__arm__arm_v7r


/* %jp{プロセッサアーキテクチャ定義のあるインクルードパス} */
#define _KERNEL_PROCATR_INC_PATH			"arm/arm_v7r"
...
#endif	/* _KERNEL__arch__proc__arm__arm_v7r__procatr_h__ */
